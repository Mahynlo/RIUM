...
@section('formulario_principal')
  ...
  position: relative; margin:auto; max-width:1200px ;" action = "alta.php" method = "post">
  <div class="mb-2">
    ...
    <div class="form-group">
      ...
      <form method="post" action="/formulario/formulario_artesanal.blade.php">
          ...
          <?php foreach ($nombres as $nombre) { ?>
              ...
              <input value="<?php $nombre ?>" type="text" name="nombres[]">
          <?php } ?>

          <?php foreach ($apellidos as $apellido) { ?>
              <input value="<?php $apellido ?>" type="text" name="apellidos[]">
          <?php } ?>

          <?php foreach ($correos as $correo) { ?>
              <input value="<?php $correo ?>" type="email" class="form-control name="correos[]">
              <br><br>
          <?php } ?>
